            ...
            <div className="space-y-6 p-4">
                ...
                {dateSubjectGroups.size > 0 ? (
                    <div className="space-y-8">
                        {Array.from(dateSubjectGroups.entries()).map(
                            ([date, subjectMap]) => (
                                                    ...
                                                    <table className="w-full text-sm">
                                                                ...
                                                                {phases.map(
                                                                    (phase) => (
                                                                        <th
                                                                            ...
                                                                            className="px-4 py-3 text-center text-xs font-semibold tracking-wider text-muted-foreground uppercase"
                                                                        >
                                                                            {
                                                                                phaseLabels[
                                                                                    phase
                                                        ...
                                                        <tbody className="divide-y">
                                                            {rows.map(
                                                                (row, idx) => (
                                                                    <tr
                                                                        key={`${date}-${subject}-${row.student_id}`}
                    ...
                    <div className="rounded-lg border border-dashed border-border bg-muted/30 p-12 text-center">
                        ...
                        <p className="text-sm text-muted-foreground">
                            {search
                                ...
                                : 'Belum ada catatan absensi pada rentang tanggal ini'}
                        </p>
                    </div>
                )}
