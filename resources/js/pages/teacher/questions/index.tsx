                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="mt-2 text-muted-foreground">
                            Di halaman ini Anda menambahkan, mengedit, dan
                            menghapus soal untuk ujian ini.
                        </p>
                    </div>
                    <Button asChild>
                        <Link
                    ...
                    <CardContent>
                        {questions.length === 0 ? (
                            <p className="text-sm text-muted-foreground">
                                Belum ada soal. Klik tombol Tambah Soal untuk
                                mulai membuat soal.
                            </p>
                        ) : (
                                        ...
                                        <div className="flex flex-wrap items-start justify-between gap-4">
                                            <div className="space-y-2">
                                                <div>
                                                    ...
                                                    <div
                                                        className="prose prose-sm mt-1 max-w-none font-medium text-foreground dark:prose-invert"
                                            ...
                                            <div className="flex gap-2">
                                                ...
                                                >
                                                    <Link
                                                        href={QuestionController.edit.url(
                                                            {
                                                                exam: exam.id,
                                                                question:
                                                                    question.id,
                                                ...
                                                >
                                                    <Link
                                                        href={QuestionController.destroy.url(
                                                            {
                                                                exam: exam.id,
                                                                question:
                                                                    question.id,
