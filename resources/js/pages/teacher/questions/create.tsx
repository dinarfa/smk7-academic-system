            ...
            <div className="space-y-6 p-4">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Isi pertanyaan, tipe soal, poin, dan jawaban yang
                            benar.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Penjelasan atau langkah-langkah penyelesaian
                                    soal. Siswa dapat melihat pembahasan ini
                                    setelah ujian selesai sebagai bahan evaluasi
                                    belajar.
                                </p>
                                <textarea
                                    id="explanation"
