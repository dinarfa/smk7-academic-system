                ...
                <div className="flex flex-wrap items-start justify-between gap-4">
                    <div>
                        ...
                        <p className="mt-2 text-muted-foreground">
                            {attempt.student_name} - {exam.title}
                        </p>
                    </div>
                    ...
                    {questions.map((question, index) => {
                        ...
                        return (
                            <Card
                                key={question.id}
                                className={
                                    isEssay ? 'border-2 border-primary/50' : ''
                                }
                            >
                                ...
                                <CardContent className="space-y-4">
                                    <div
                                        className="prose prose-sm max-w-none rounded-md bg-muted p-4 dark:prose-invert"
                                                    ...
                                                    .map((opt) => (
                                                        ...
                                                        >
                                                            <div
                                                                ...
                                                                className="prose prose-sm inline-block dark:prose-invert"
                                                            />
                                                        </li>
                                                    ))}
                                            </ul>
