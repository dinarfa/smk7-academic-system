            ...
            <div className="space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Pilih kelas dan rentang tanggal untuk melihat rekap.</CardDescription>
                    </CardHeader>
                    <CardContent>
                    ...
                    <div className="grid gap-4 sm:grid-cols-5">
                        ...
                        <Card>
                            <CardContent className="pt-6">
                                ...
                                <p className="text-2xl font-bold text-amber-600">{summary.excused}</p>
                            </CardContent>
                        </Card>
                    </div>
                )}
                ...
                {classId && (
                    <Card>
                        ...
                        <CardContent className="space-y-3">
                            {sessions.length === 0 ? (
                                <p className="text-sm text-muted-foreground">Tidak ada sesi absensi untuk filter ini.</p>
                            ) : (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-4 text-sm">
                                            <div className="text-center">
                                                <p className="font-bold text-emerald-600">{session.present}</p>
                                                <p className="text-muted-foreground">Hadir</p>
                                            </div>
                                            <div className="text-center">
                                                <p className="font-bold text-rose-600">{session.absent}</p>
                                                <p className="text-muted-foreground">Absen</p>
                                            </div>
                                            <div className="text-center">
                                                <p className="font-bold text-amber-600">{session.excused}</p>
                                                <p className="text-muted-foreground">Izin</p>
                                            </div>
                                            <div className="text-center">
                                                <p className="font-bold">{session.total}</p>
