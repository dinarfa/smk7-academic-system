...
beforeEach(function () {
    // Freeze time at 10:00 AM to avoid midnight-crossing issues in schedule comparisons
...
test('teacher without assigned classes cannot save manual attendance', function () {
    $teacher = User::factory()->teacher()->create();
